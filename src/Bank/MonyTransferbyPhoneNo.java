...
public class MonyTransferbyPhoneNo extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    MonyTransferbyPhoneNo frame = new MonyTransferbyPhoneNo();
    ...
    public MonyTransferbyPhoneNo() {
        ...
        passwordField.setBounds(472, 224, 208, 34);
        ...
        JLabel lblMobileNumber1 = new JLabel("Mobile Number:");
        ...
        btnTransfer.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
            	String senderPhnNo=textField.getText();
            	String receiverPhnNo=textField_1.getText();
            	double amountToTransfer=Double.parseDouble(textField_2.getText());
            	String password=passwordField.getText();
            	data.transferMoneybyPhoneNo(senderPhnNo, receiverPhnNo,password,amountToTransfer);
            }
        });
